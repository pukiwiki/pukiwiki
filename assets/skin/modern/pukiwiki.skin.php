...
<div id="header">
 <a href="<?php echo $link['top'] ?>"><img id="logo" src="<?php echo PKWK_HOME.SKIN_DIR . $image['logo'] ?>" width="80" height="80" alt="[PukiWiki]" title="[PukiWiki]" /></a>
...
$_IMAGE['skin']['login']      = 'login.png';
$_IMAGE['skin']['logout']      = 'logout.png';

function _toolbar($key, $x = 35, $y = 35){
...
<div id="path">
 <?php if ($is_page) { ?>
  ...
  <?php } else { ?>
   <span class="small">
    <?php
        if ($defaultpage == $title) {echo $defaultpage;} else 
        {
...
<div id="contents">
 <?php
if ($menu !== FALSE || $rightbar) { ?>
<input type="checkbox" id="menubtn_check">
<label for="menubtn_check" id="menubtn"><img src="<?php echo SKIN_DIR . "icon/" . "menu.png"; ?>" style="width:35px;height:35px;opacity:0.75;" /></label>
<?php } ?>
<?php if ($menu !== FALSE) { ?>
 <div id="menubar" class="menu"><div class="body"><?php echo $menu ?></div></div>
<?php } ?>
 <div id="body">
    <?php echo $body ?>
    <?php if ($notes != '') { ?>
...
<?php if ($rightbar) { ?>
 <div id="rightbar" class="menu"><div class="body"><?php echo $rightbar ?></div></div>
<?php } ?>
</div>
<?php if ($attaches != '') { ?>
<div id="attach">
...
<div id="footer">
 Owner: <a href="<?php echo $modifierlink ?>"><?php echo $modifier ?></a>
 <p>
 <?php echo "Powered by " . S_COPYRIGHT ?>
