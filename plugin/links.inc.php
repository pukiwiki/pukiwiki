...
//
// $Id: links.inc.php,v 1.14 2003/03/13 14:10:52 panda Exp $
//
...
function plugin_links_init()
{
	$messages = array(
		'_links_messages'=>array(
			'title_update'  => 'データベース更新',
			'msg_adminpass' => '管理者パスワード',
			'btn_submit'    => '実行',
			'msg_done'      => 'データベース更新が完了しました。',
			'msg_usage'     => "
* 処理内容

:データベースを更新|
全てのページをスキャンし、あるページがどのページからリンクされているかを調査して、データベースに記録します。
